...
public class YuleFragment extends Fragment {
    private String URL="http://v.juhe.cn/toutiao/index?key="+ juhe.getKey()+"&type=top";
    ...
    public View onCreateView(final LayoutInflater inflater,
        ...
        final View view = inflater.inflate(R.layout.fragment_yule,
                container, false);
        recyclerView = view.findViewById(R.id.YulerecyclerView);

...
public class JiankangFragment extends Fragment {
    private String URL="http://v.juhe.cn/toutiao/index?key="+ juhe.getKey()+"&type=jiankang";
    ...
    public View onCreateView(final LayoutInflater inflater,
        ...
        final View view = inflater.inflate(R.layout.fragment_jiankang,
                container, false);
        recyclerView = view.findViewById(R.id.JiankangrecyclerView);

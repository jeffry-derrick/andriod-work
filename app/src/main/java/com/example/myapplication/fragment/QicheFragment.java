...
public class QicheFragment extends Fragment {
    private String URL="http://v.juhe.cn/toutiao/index?key="+ juhe.getKey()+"&type=qiche";
    ...
    public View onCreateView(final LayoutInflater inflater,
        ...
        final View view = inflater.inflate(R.layout.fragment_qiche,
                container, false);
        recyclerView = view.findViewById(R.id.QicherecyclerView);

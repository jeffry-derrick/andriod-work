...
public class YouxiFragment extends Fragment {
    private String URL="http://v.juhe.cn/toutiao/index?key="+ juhe.getKey()+"&type=youxi";
    ...
    public View onCreateView(final LayoutInflater inflater,
        ...
        final View view = inflater.inflate(R.layout.fragment_youxi,
                container, false);
        recyclerView = view.findViewById(R.id.YouxirecyclerView);

...
public class GuoneiFragment extends Fragment {
    private String URL="http://v.juhe.cn/toutiao/index?key="+ juhe.getKey()+"&type=guonei";
    ...
    public View onCreateView(final LayoutInflater inflater,
        ...
        final View view = inflater.inflate(R.layout.fragment_guonei,
                container, false);
        recyclerView = view.findViewById(R.id.GuoneirecyclerView);

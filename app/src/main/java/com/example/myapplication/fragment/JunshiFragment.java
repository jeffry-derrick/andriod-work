...
public class JunshiFragment extends Fragment {
    private String URL="http://v.juhe.cn/toutiao/index?key="+ juhe.getKey()+"&type=junshi";
    ...
    public View onCreateView(final LayoutInflater inflater,
        ...
        final View view = inflater.inflate(R.layout.fragment_junshi,
                container, false);
        recyclerView = view.findViewById(R.id.JunshirecyclerView);

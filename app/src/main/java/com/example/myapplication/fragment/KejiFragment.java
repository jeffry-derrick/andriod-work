...
public class KejiFragment extends Fragment {
    private String URL="http://v.juhe.cn/toutiao/index?key="+ juhe.getKey()+"&type=keji";
    ...
    public View onCreateView(final LayoutInflater inflater,
        ...
        final View view = inflater.inflate(R.layout.fragment_keji,
                container, false);
        recyclerView = view.findViewById(R.id.KejirecyclerView);
